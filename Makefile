...
main : main.o outilParsage.o tout.o jdm.o outilNet.o json.o BakuSemantic.o wikipedia.o
	$(CXX) $(CXXFLAGSD) main.o outilParsage.o tout.o jdm.o outilNet.o json.o BakuSemantic.o wikipedia.o $(INCPATH) -o Bakounibot
